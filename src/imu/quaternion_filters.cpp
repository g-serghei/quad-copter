...
void calculate_euler_angles(AxisType *angles)
{
...
void madgwick_quaternion_update(AxisType *angles, float deltat, float ax, float ay, float az, float gx, float gy, float gz)
{
